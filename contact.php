				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a class="logo" href="index.html">
							<img src="./img/empresa.png" alt="logo">
						</a>
					</div>
					<!-- /Logo -->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						...
						<h1 class="white-text">Estamos en Contacto.</h1>
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-offset-1">
						...
						<ul class="contact-details">
							<li><i class="fa fa-envelope"></i>manager.engineergreen@gmail.com</li>
							<li><i class="fa fa-phone"></i> +51 993315523</li>
							<li><i class="fa fa-map-marker"></i>Jr.Israel Mz.193 Lt.30 - Yarinacocha</li>
						</ul>
				...
				<div id="bottom-footer" class="row">
					...
					<div class="col-md-8 col-md-pull-4">
						<div class="footer-copyright">
							<span>&copy; Derechos Rervados &nbsp;&bull;&nbsp; Pucallpa - Perú.</a></span>
						</div>
					</div>
					<!-- /copyright -->
